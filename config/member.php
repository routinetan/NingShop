...
return [
    ...
    //是否只保持一个子菜单的展开
    'unique_opened' => false,
    'bootstrap' => app_path('Member/bootstrap.php'),
    'route' => [
        'domain' => null,
        'prefix' => env('ADMIN_ROUTE_PREFIX', 'member'),
        'api_prefix' => env('ADMIN_API_ROUTE_PREFIX', 'member-api'),
        'namespace' => 'App\\Member\\Controllers',
        'middleware' => ['web', 'member'],
    ],
    'directory' => app_path('Member'),
    'https' => env('ADMIN_HTTPS', false),
    'auth' => [
        'controller' => App\Member\Controllers\AuthController::class,
        'guard' => 'admin',
        'guards' => [
            'admin' => [
                'driver' => 'session',
